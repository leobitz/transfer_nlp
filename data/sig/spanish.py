import random
lines = open("spanish-task3-merged", encoding='utf-8').readlines()
data = []
for line in lines:
...
file = open("spanish-task3-test.txt", encoding='utf-8', mode='w')
for i in range(test_size):
    ...
    file.write(line)
file.close()
file = open("spanish-task3-train.txt", encoding='utf-8', mode='w')
